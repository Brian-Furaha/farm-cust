                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../code.php" method="post">
                      ...
                      <input type="password" class="form-control my-3" name="password" placeholder="Create password" required />
                      <input type="password" class="form-control my-3" name="cpassword" placeholder="Confirm password" required />
                      <!-- roles -->
                      <div class="row my-3">
                        <span class="text-muted fs-7">ROLE <i class="fa-sharp fa-solid fa-circle-question" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-content="Enter your date of birth"></i></span>
                        <div class="col">
                        ...
                        <div class="col">
                          <div class="border rounded p-2">
                            ...
                            <input class="form-check-input" type="radio" name="flexRadioDefault" value="farmer" id="flexRadioDefault2" />
                          </div>
                        </div>
                        <div class="col">
                          <div class="border rounded p-2">
                            <label class="form-check-label" for="flexRadioDefault3">Customer </label>
                            <input class="form-check-input" type="radio" name="flexRadioDefault" value="customer" id="flexRadioDefault3" />
                          </div>
                        </div>
                        <div>
                        </div>
